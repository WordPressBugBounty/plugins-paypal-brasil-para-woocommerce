...
= 1.7.4 =
* Fixed: Issue with payment refund notifications.
...
= 1.6.9 =
* Fixed the fields submitted by the form
* Improvement: Adds mask validation in fields
...
= 1.6.5 =
* Fix error payment from page of individual payment.
* Fix PHP warnings.
...
= 1.6.0 =
* Fix error on logs information.

= 1.5.9 =
* Improvement on payment experience.
* Fix error from array null on create order checkout.

= 1.5.8 =
* Fixed error on PHP plataform check.
* Improvement on create order.
* Improvement on checkout experience.
